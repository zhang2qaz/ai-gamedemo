...
export const STOCK_THEME: ThemeConfig = {
  ...
  mechanicsDescription: '📈 高波动模式 · 低惯性高波动 · 独家做空加成更强 · 连续造势效率急降',
  configOverrides: {
    atkBaseBonus: 14.0,            // 做空/砸盘威力极大
    atkCooldownFactor: 0.45,       // 连续做空冷却更重
    atkSoloInflux: 1.4,            // 独家做空获利更高
    momentumGainFromMkt: 1.5,      // 造势=制造泡沫（已削弱）
    momentumCap: 5.0,              // 泡沫天花板更高
    momentumDecayOnHold: 3.0,      // 观望=撤资，动量崩盘
    mktConsecutiveFatigue: 0.5,    // 连续造势效率更差（市场麻木）
    holdDefenseBarrier: 0.5,       // 持仓防御较弱（股市波动大）
